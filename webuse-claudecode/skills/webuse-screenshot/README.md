...
Claude Code Skill for reading the current graphical desktop resolution before every screen task, then capturing full-screen, half-screen, or custom rectangular screenshots.

Main file: `scripts/webuse-screenshot.py`
