# WebMind for Claude Code on macOS — User Guide

[中文版](使用教程.md)

This guide covers **WebMind for Claude Code on macOS**. It starts with the simplest installation and first-use path, then provides commands for diagnosis and troubleshooting.
