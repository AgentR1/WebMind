...
description: Use webmind-mouse-control for authorized local macOS Claude Code browser or desktop tasks requiring verified desktop pointer movement, clicks, holds or scrolling.
---

# webmind-mouse-control - macOS / Claude Code
