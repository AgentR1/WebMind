---
name: webmind-mouse-control
description: Use webmind-mouse-control for authorized local Windows Claude Code browser or desktop tasks requiring verified desktop pointer movement, clicks, holds or scrolling.
---

# webmind-mouse-control - Windows / Claude Code
...
```powershell
& "$WebMindRoot\scripts\webmind.ps1" mouse <command> [options]
```
