---
name: webmind-cdp
description: Use webmind-cdp for authorized local macOS Claude Code browser or desktop tasks requiring Mem-bound browser launch, verified CDP, DOM interaction or tabs.
---
