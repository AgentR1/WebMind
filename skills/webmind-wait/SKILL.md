---
name: webmind-wait
description: Use webmind-wait for authorized local macOS Claude Code browser or desktop tasks requiring bounded wait-and-inspect cycles.
---
...
Use an already authorized native shell wait: `sleep 2`.
