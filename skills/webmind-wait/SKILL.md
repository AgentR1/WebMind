---
name: webmind-wait
description: Use webmind-wait for authorized local Windows Claude Code browser or desktop tasks requiring bounded wait-and-inspect cycles.
---

# webmind-wait - Windows / Claude Code
...
This component is a workflow guide, not a registered `webmind wait` command.
Use an already authorized native shell wait: `Start-Sleep -Seconds 2`.
