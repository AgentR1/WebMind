...
from runtime import native_desktop_geometry
...
def _open_mss(*, with_cursor: bool = False):
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "upgrade webmind-claudecode dependencies with the plugin installer"
        )
...
def read_resolution() -> DesktopInfo:
    ...
    raise RuntimeError(
        ...
        "the webmind-claudecode plugin installer, make sure a graphical session is active, "
...
def _overlay_cursor_marker(
    ...
    result: Dict[str, Any] = {
        ...
        "position": {"x": x, "y": y, "coordinate_space": "macos-logical-points"},
    }
...
def _base_result(task: str, desktop_info: DesktopInfo) -> Dict[str, Any]:
    return {
        ...
        "desktop_coordinate_space": "macos-logical-points",
