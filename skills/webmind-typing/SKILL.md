---
name: webmind-typing
description: Use webmind-typing for authorized local Windows Claude Code browser or desktop tasks requiring focused non-sensitive ASCII keyboard input and shortcuts.
---

# webmind-typing - Windows / Claude Code
...
```powershell
& "$WebMindRoot\scripts\webmind.ps1" typing <command> [options]
```
...
The `primary`/`mod` alias is Ctrl on Windows.
