#!/usr/bin/env python3
"""Mouse control utility for Codex.
...
def load_pyautogui():
    try:
        ...
        raise RuntimeError(
            ...
            "Run the webmind-codex project installer for this platform."
        ) from exc
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Control the local mouse pointer for Codex GUI automation.")
