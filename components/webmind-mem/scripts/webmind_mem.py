...
def initialization_status() -> Dict[str, Any]:
    base: Dict[str, Any] = {
        ...
        "name_rule": "xxx-yyy-mem; xxx=1-8 lowercase English letters; yyy=1-999 without leading zero; both xxx and yyy must each be unique among WebMind Mem folders on this computer; port=9000+yyy; range=9001-9999",
